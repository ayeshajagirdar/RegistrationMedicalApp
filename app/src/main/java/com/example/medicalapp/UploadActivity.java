...
public class UploadActivity extends AppCompatActivity {
    ...
    DatabaseReference root = FirebaseDatabase.getInstance().getReference("Medical wala");
    StorageReference reference = FirebaseStorage.getInstance().getReference("Medical wala");
    Uri imageUri;
    private Object ImageUploadModel;
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        Toast.makeText(UploadActivity.this, "Items Uploaded Successfully...", Toast.LENGTH_SHORT).show();
                        title.getText().clear();
